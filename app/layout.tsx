...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    apple: [{ url: '/pwa/apple-touch-icon-180x180.png', sizes: '180x180', type: 'image/png' }]
  },
  other: {
